    ...
    return(
        <section id="hero-section" className="container mx-auto h-screen flex">
            <div className="relative self-center">
                <Image src="/images/img-basketball.svg" width={432} height={423} alt="image sporton" className="grayscale absolute letf-0 -top-20"/>
                ...
                <Image src="/images/img-hero.svg" width={700} height={950} alt="image sporton hero" className="absolute -right-5 top-1/2 -translate-y-1/2"/>
            </div>
