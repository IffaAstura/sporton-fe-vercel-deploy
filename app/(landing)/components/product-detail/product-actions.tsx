        ...
        <div className="flex gap-5">
            <div className="border border-gray-500 inline-flex w-fit min-w-20.5">
                ...
                <div className="flex flex-col">
                    ...
                    // Jika qty lebih dari satu maka dapat di kurangi, dan jika qty dibawah 1 maka tidak dapat dikurangi
                    onClick={() => setQty(qty > 1 ? qty -1 : qty)}> 
                        <FiChevronDown/></button>
                </div>
            </div>
            <Button className="px-20 w-full" onClick={handleAddToCart}><FiShoppingBag size={24}/>Add to Cart</Button>
            <Button variant="dark" className="px-20 w-full" onClick={goToCheckout}>Checkout Now<FiArrowRight size={24}/></Button>
        </div>
    );
};
