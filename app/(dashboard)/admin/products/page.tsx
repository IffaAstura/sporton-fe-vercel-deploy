...
const ProductManagement = () => {
    ...
    const [productToDeleteId, setProductToDeleteIs] = useState("");
    ...
    return(
        <div>
            <div className="flex justify-between items-center mb-10">
                ...
                <Button className="rounded-lg" onClick={() => setIsModalOpen(true)}><FiPlus size={24}/>Add Product</Button>
            </div>
