...
import { createPoduct, updateProduct } from "@/app/services/product.service";
        ...
        <Modal isOpen={isOpen} onClose={onClose} title={isEditMode ? "Edit Product":"Add New Product"}>
            <form onSubmit={handelSubmit} className="flex flex-col gap-6">
                    ...
                    <div className="flex flex-col gap-4 w-full">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div className="input-group-admin">
                                ...
                                <input type="number" id="price" name="price" value={formData.price} onChange={handleChange} placeholder="0" />
                            </div>
                            <div className="input-group-admin">
                                <label htmlFor="stock">Stock</label>
                                <input type="number" id="stock" name="stock" value={formData.stock} onChange={handleChange} placeholder="0" />
                            </div>
                        </div>
                        <div className="input-group-admin">
                ...
                <div className="input-group-admin">
                    ...
                    <textarea name="description" id="description" value={formData.description} onChange={handleChange} rows={7} placeholder="Product Details..."></textarea>
                </div>
                <Button className="ml-auto mt-3 rounded-lg" onClick={handelSubmit} disabled={isSubmitting} type="submit">
                    {
