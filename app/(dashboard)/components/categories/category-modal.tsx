...
const CategorytModal = ({isOpen, onClose, onSuccess, category}: TCategoryModalProps) => {
    ...
    const handelSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            console.error(isEditMode ? "Failed tp update category":"Failed to create category")
            toast.error(isEditMode ? "Failed tp update category":"Failed to create category")
        }   finally {
                ...
                <div className="flex gap-7">
                    ...
                    <div className="flex flex-col gap-4 w-full">
                        ...
                        <div className="input-group-admin">
                            ...
                            <textarea name="description" id="description" value={formData.description} onChange={handleChange} rows={4} placeholder="Product Details..."></textarea>
                        </div>
                    </div>
                </div>
                <Button className="ml-auto mt-3 rounded-lg" onClick={handelSubmit} disabled={isSubmitting}>
                    {
